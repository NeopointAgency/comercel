...
export default function Home() {
  ...
  useEffect(() => {
    document.title = "Comercel | Compra por Mayoreo";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute('content', 'En Comercel te ayudamos a surtir tu negocio con buen servicio, precios competitivos y seguimiento real.');
    }
    const checkMobile = () => {
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-12 mb-20">
          ...
          <div>
            ...
            <ul className="grid gap-4 opacity-60">
              ...
              <li><Link to="/ajo-mayoreo-cancun" className="hover:text-comercel-green transition-colors">Ajo Mayoreo Cancún</Link></li>
              ...
              {isMobile ? (
                <div className="flex-grow flex flex-col items-center justify-center p-8 bg-comercel-gray/30">
                  ...
                  <div className="flex flex-col gap-4 w-full max-w-xs">
                    ...
                    >
                      <img src="https://upload.wikimedia.org/wikipedia/commons/6/6b/WhatsApp.svg" alt="WhatsApp" className="w-5 h-5 object-contain" />
